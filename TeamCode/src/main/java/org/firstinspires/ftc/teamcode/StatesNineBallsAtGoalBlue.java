...
@Config
@Autonomous(name = "StatesNineBallsAtGoalBLUE", group = "Autonomous")
public class StatesNineBallsAtGoalBlue extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      /* PIDFCoefficients pf = new PIDFCoefficients(0.0005, 0, 0, 12.8222);
        ...
        Action Scrimmage2Auto = drive.actionBuilder(beginPose)
                ...
                // Lines up for shot
                //.stopAndAdd(new runShooter())
                .strafeToLinearHeading(new Vector2d(-45,-27), Math.toRadians(-135))
                .stopAndAdd(new smartFeedNear())
