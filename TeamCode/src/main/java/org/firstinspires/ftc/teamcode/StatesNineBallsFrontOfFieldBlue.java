...
@Config
@Autonomous(name = "StatesNineBallsFrontOfFieldBLUE", group = "Autonomous")
public class StatesNineBallsFrontOfFieldBlue extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      /* PIDFCoefficients pf = new PIDFCoefficients(0.0005, 0, 0, 12.8222);
        ...
        Action Scrimmage2Auto = drive.actionBuilder(beginPose)
                ...
                .strafeToLinearHeading(new Vector2d(34, -35), Math.toRadians(-90))
