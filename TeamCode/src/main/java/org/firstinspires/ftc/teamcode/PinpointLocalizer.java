...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1971.0937647415515; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3415.7499937645384; // x position of the perpendicular encoder (in tick units)
    }
