...
@Config
@Autonomous(name = "sampleFrontOfFieldBlueComplexPathing", group = "Autonomous")
public class sampleFrontOfFieldBlueComplexPathing extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action path2 = drive.actionBuilder(beginPose)
                ...
                .strafeToLinearHeading(new Vector2d(34,-12),Math.toRadians(220))
                .strafeTo(new Vector2d(-12,-12))
                .turn(Math.toRadians(50))
                .strafeTo(new Vector2d(-34,-12))
                .build();
